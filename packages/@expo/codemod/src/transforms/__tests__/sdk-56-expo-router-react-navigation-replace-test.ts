...
const run = (source: string): string => applyTransform(transform, {}, { source, path: 'this/is/test.tsx' });
...
describe('basic replacements', () => {
  ...
  test('replaces all four react-navigation packages in one file', () => {
    ...
    expect(output).toContain(`import { createMaterialTopTabNavigator } from "expo-router/js-top-tabs"`);
