...
async function resolveVideoSourceAsync(
  sourceFilename: string,
...
function renderThumbnail(video: HTMLVideoElement, quality: number): VideoThumbnailsResult {
...
function normalizeRequestedTimeSeconds(timeMs: number | undefined): number {
...
function isHttpSource(sourceFilename: string): boolean {
  try {
